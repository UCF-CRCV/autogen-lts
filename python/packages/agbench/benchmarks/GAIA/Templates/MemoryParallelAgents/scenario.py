...
def _gaia_question_scorer(model_answer: str, ground_truth: str) -> bool:
    ...
    Copied from the official GAIA scorer (see GAIA leaderboard code) so that
    per-run correctness for the first-team and aggregated answers can be
    logged locally in each result folder.
    """
