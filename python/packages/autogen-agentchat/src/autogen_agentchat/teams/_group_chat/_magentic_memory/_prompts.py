...
IMPORTANT: You are coordinating a team working in parallel with other teams on the same task. Shared memory information from other teams will be automatically provided during orchestration. When creating your plan, consider what approaches other teams might be taking to avoid duplication and learn from their successes or failures.
...
CRITICAL: Shared memory information from other parallel teams has been automatically provided above (if available). 
YOU MUST REVIEW AND USE THIS INFORMATION in your decision-making.

BEFORE making any decision, check if shared memory contains:
- ANSWERS or SOLUTIONS that you can use directly
- FINDINGS or DATA that you can build upon
- COMPLETED WORK that you should not duplicate
- FAILED APPROACHES that you should avoid repeating

If shared memory contains relevant information:
- EXPLICITLY REFERENCE it in your "reason" fields
- USE the information directly instead of duplicating work
- ADAPT your instructions based on what others have found
- If another team already found the answer, use their result instead of starting over

If shared memory does NOT contain relevant information:
- State this explicitly in your reasoning
- Proceed with your own approach
...
To make progress on the request, please answer the following questions, including necessary reasoning:
    ...
    - What instruction or question would you give this team member? (Phrase as if speaking directly to them, and include any specific information they may need. **MUST explicitly reference shared memory if it contains relevant information.** Example: "Based on shared memory, Team 2 already found [X], so use that instead of [Y].")
...
IMPORTANT: Shared memory information from other parallel teams has been automatically provided. Use this information to adapt your plan - learn from what has worked for others and avoid repeating failed approaches.
